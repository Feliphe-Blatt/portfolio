...
|---|--------|--------|--------|-------|
| 1 | **Scrum Master** | Orquestração e coordenação | ✅ Ativo | [scrum-master.md](./agents/scrum-master.md) |
| 2 | **Análise & Planejamento** | Arquitetura e design de sistema | ✅ Ativo | [analise-planejamento.md](./agents/analise-planejamento.md) |
| 3 | **Designer** | UX/UI e wireframes | ✅ Ativo | [designer.md](./agents/designer.md) |
| 4 | **Backend** | Spring Boot e APIs REST | ⚪ Standby | [backend.md](./agents/backend.md) |
| 5 | **Frontend** | Next.js/React/TypeScript | ✅ Ativo | [frontend.md](./agents/frontend.md) |
| 6 | **Database Scripts** | SQL e Flyway migrations | ⚪ Standby | [database-scripts.md](./agents/database-scripts.md) |
| 7 | **Segurança** | Vulnerabilidades e autenticação | ✅ Ativo | [seguranca.md](./agents/seguranca.md) |
| 8 | **Performance** | Otimizações e caching | ✅ Ativo | [performance.md](./agents/performance.md) |
| 9 | **Acessibilidade** | WCAG 2.1 e navegação assistiva | ✅ Ativo | [acessibilidade.md](./agents/acessibilidade.md) |
| 10 | **Testes & QA** | Unitários, integração, E2E | ⚪ Standby | [testes.md](./agents/testes.md) |
| 11 | **Code Review** | Qualidade e refatoração | ⚪ Standby | [code-review.md](./agents/code-review.md) |
| 12 | **Documentação** | README, Javadoc, diagramas | ✅ Ativo | [documentation.md](./agents/documentation.md) |
...
- [Insights da Repaginação](../portfolio-v2/INSIGHTS-REPAGINACAO.md)
- [Código Fonte](../portfolio-v2/src/)
